var app = angular.module('movieApp', ['ui.router', 'LocalForageModule', 'underscore']) || {};
...
app.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function($stateProvider, $urlRouterProvider, $locationProvider) {
  ...
  $stateProvider
    ...
    .state('movies', {
		url: "/movies",
		templateUrl: "./views/tabPage.html",
...
app.controller('movieCtrl', ['$scope', 'data', function($scope, data){
	"use strict";
